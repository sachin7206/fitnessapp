...
const styles = StyleSheet.create({
  ...
  currentPlanStatusBadge: { backgroundColor: '#22C55E20', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8 },
  ...
  planCardSelected: { borderColor: colors.primary, backgroundColor: '#F9FAFB' },
