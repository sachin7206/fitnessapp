...
const styles = StyleSheet.create({
  ...
  header: { backgroundColor: '#111827', padding: spacing.md, paddingTop: spacing.xxl, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  ...
  tipCard: { backgroundColor: '#F3F4F6', borderRadius: borderRadius.lg, padding: spacing.md, marginBottom: spacing.md, borderLeftWidth: 4, borderLeftColor: '#111827' },
  tipLabel: { fontWeight: '600', color: '#111827', marginBottom: 4 }, tipContent: { color: colors.text.primary, lineHeight: 22 },
  ...
  planStat: { ...typography.caption, color: '#111827', fontWeight: '600' },
  ...
  newPlanBtn: { marginTop: spacing.xs }, newPlanText: { color: '#111827', fontWeight: '600', textAlign: 'center' },
  createPlanCard: { backgroundColor: '#111827', borderRadius: borderRadius.lg, padding: spacing.md, flexDirection: 'row', alignItems: 'center', marginBottom: spacing.md, ...shadows.md },
  ...
  numBtn: { fontSize: 24, color: '#111827', fontWeight: 'bold', width: 36, textAlign: 'center' }, numVal: { fontSize: 18, fontWeight: 'bold' },
  generateBtn: { backgroundColor: '#111827', padding: spacing.md, borderRadius: borderRadius.md, alignItems: 'center', marginTop: spacing.md },
  ...
  sessionDay: { fontWeight: '600', color: '#111827', width: 80, fontSize: 11 }, sessionName: { fontWeight: '600', color: colors.text.primary }, sessionDesc: { ...typography.caption, color: colors.text.secondary },
  assignBtn: { backgroundColor: '#111827', padding: spacing.md, borderRadius: borderRadius.md, alignItems: 'center', marginTop: spacing.md },
  ...
  poseSanskrit: { fontSize: 10, color: colors.text.secondary, fontStyle: 'italic' }, poseDuration: { fontSize: 10, color: '#111827', marginTop: 2 },
  ...
  listMeta: { ...typography.caption, color: '#111827', marginTop: 4 },
  ...
  modalSanskrit: { fontStyle: 'italic', color: '#111827', marginBottom: spacing.sm },
  ...
  modalTag: { backgroundColor: '#111827' + '20', paddingHorizontal: spacing.sm, paddingVertical: 2, borderRadius: borderRadius.sm, color: '#111827', fontSize: 12 },
});
