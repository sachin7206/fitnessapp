...
const styles = StyleSheet.create({
  ...
  summaryTitle: { fontSize: 18, fontWeight: 'bold', color: colors.text.primary, marginBottom: spacing.md },
  summaryRow: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: spacing.sm },
  summaryLabel: { fontSize: 15, color: colors.text.secondary },
  summaryValue: { fontSize: 15, color: colors.text.primary, fontWeight: '500' },
  summaryTotal: { borderTopWidth: 1, borderTopColor: '#E9ECEF', paddingTop: spacing.sm, marginTop: spacing.sm },
  ...
  methodDesc: { fontSize: 12, color: colors.text.secondary, marginTop: 2 },
  recommendedTag: {
    backgroundColor: colors.success, paddingHorizontal: 8, paddingVertical: 2,
    borderRadius: 6, alignSelf: 'flex-start', marginTop: 6,
  },
  recommendedTagText: { color: '#FFF', fontSize: 10, fontWeight: 'bold' },
  radio: {
  ...
  upiInput: {
    backgroundColor: colors.surface, borderWidth: 1, borderColor: '#DDD',
  ...
  amountValue: { color: '#FFF', fontSize: 36, fontWeight: 'bold', marginTop: 4 },
  qrContainer: { alignItems: 'center', marginTop: spacing.lg, width: '100%' },
  qrTitle: { fontSize: 16, fontWeight: '600', color: colors.text.primary, marginBottom: spacing.md },
  qrImageWrapper: {
    backgroundColor: '#FFF', padding: spacing.md, borderRadius: 16,
    shadowColor: '#000', shadowOpacity: 0.1, shadowRadius: 10, elevation: 5,
  },
  qrImage: { width: 250, height: 250 },
  qrHint: { fontSize: 13, color: colors.text.secondary, textAlign: 'center', marginTop: spacing.md, lineHeight: 20, paddingHorizontal: spacing.lg },
  upiAppButton: {
    backgroundColor: '#6C63FF', paddingVertical: 14, paddingHorizontal: spacing.xl,
    borderRadius: 12, marginTop: spacing.lg, width: '100%', alignItems: 'center',
  },
  upiAppButtonText: { color: '#FFF', fontSize: 16, fontWeight: 'bold' },
  merchantInfo: {
    marginTop: spacing.lg, paddingVertical: spacing.md, paddingHorizontal: spacing.lg,
    backgroundColor: '#F0F0F0', borderRadius: 12, width: '100%',
  },
  merchantLabel: { fontSize: 13, color: colors.text.secondary, marginBottom: 4 },
  confirmButton: {
  ...
  utrSection: {
    ...
    borderRadius: 12, padding: spacing.lg, borderWidth: 1.5, borderColor: colors.primary,
  },
  utrLabel: { fontSize: 15, fontWeight: 'bold', color: colors.text.primary, marginBottom: 4 },
  utrHint: { fontSize: 12, color: colors.text.secondary, marginBottom: spacing.md, lineHeight: 18 },
  utrInput: {
